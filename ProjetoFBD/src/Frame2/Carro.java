 ...
 */
@Entity
@Table(name = "carro", catalog = "sgac", schema = "")
@NamedQueries({
    ...
    , @NamedQuery(name = "Carro.findByCategoria", query = "SELECT c FROM Carro c WHERE c.categoria = :categoria")})
public class Carro implements Serializable {
    ...
    public Carro(Integer id, String modelo, String marca, String placa, String categoria) {
        this.id = id;
        this.modelo = modelo;
        this.marca = marca;
        this.placa = placa;
